...
<?php
    ...
    <th>Dados Pessoais<hr class="responsivo-hr" size="1" width="180%"></th>
  <tr>
    <td>Número de Prontuário: &nbsp;<?=$row['num_pront'];?></td>
    <td>Nome:  &nbsp;<?=$row['nome'];?></td>
    <td>Data de Nascimento:  &nbsp;<?=$row['data_nasc'];?></td>
    <table><br>
<th>Histórico <hr class="responsivo-hr" size="1" width="206%" ></th>
  <tr>
    <td>Doenças:  &nbsp;<?=$row['doencas'];?></td>
     <td>Alergias:  &nbsp;<?=$row['alergias'];?></td>
       <td>Cirurgias:  &nbsp;<?=$row['cirurgias'];?></td>
         <td>Tipo Sanguineo:  &nbsp;<?=$row['tipo_sanguineo'];?></td>
           <td>Medicamento de uso:  &nbsp;<?=$row['medicamentos'];?></td>
           </tr>
           <table><br>
           <th>Observações Médicas<hr class="responsivo-hr" size="1" width="172%"></th>
           <td><?=$row['obser_med'];?></td>
